...
import com.nmea.obj.GyrNmeaObject;
...
public class GyrNmeaCodec extends AbstractNmeaSentenceCodec {
	...
	public void decode(String content) throws Exception {
		nmeaObject = new GyrNmeaObject();
		if(!AbstractNmeaObject.GYR_PROTOL.equals(getContentType(content))){
			throw new Exception("不是GYR语句");
		}
