...
public class VelNmeaCodec extends AbstractNmeaSentenceCodec {
	...
	@Override
	//$--VEL, <1>,<2>,<3>,<4>,<5>,<6>,<7> *hh
	public void decode(String content) throws Exception {
		nmeaObject = new VelNmeaObject();
		if(!AbstractNmeaObject.VEL_PROTOL.equals(getContentType(content))){
...
//		System.out.println(msgChecksum);
		...
		//$--VEL, hhmmss.ss,x.x,x.x,x.x,x.x,x.x,x.x *hh
